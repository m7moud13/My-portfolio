...
const Navbar = () => {
    ...
    return (
    <>
        <div className="fixed w-full flex justify-between max-h-[100px] items-center p-3 px-4 mb-8 bg-[#0a192f]">
                <img src={logo} alt="" className='max-h-[50px]' />
            <ul className=' hidden md:flex text-gray-400'>
                <li className='px-4 py-2 hover:text-gray-300 duration-300 cursor-pointer'><Link to="home" smooth={true}  duration={500} >Home</Link></li>
                <li className='px-4 py-2 hover:text-gray-300 duration-300 cursor-pointer'><Link to="about" smooth={true}  duration={500} >About</Link></li>
                <li className='px-4 py-2 hover:text-gray-300 duration-300 cursor-pointer'><Link to="skills" smooth={true}  duration={500} >Skills</Link></li>
                <li className='px-4 py-2 hover:text-gray-300 duration-300 cursor-pointer'><Link to="work" smooth={true}  duration={500} >Work</Link></li>
                <li className='px-4 py-2 hover:text-gray-300 duration-300 cursor-pointer'><Link to="contact" smooth={true}  duration={500} >Contact</Link></li>
            </ul>
            {/* start mobile meune*/}
        ...
        <div className='h-screen hidden fixed left-0 md:flex flex-col items-center justify-center '>
            <div>
